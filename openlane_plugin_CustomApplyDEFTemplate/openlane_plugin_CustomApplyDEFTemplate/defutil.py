...
def relocate_pins(db, input_lefs, template_def, template_def_pins):
    # --------------------------------
    ...
    grid_errors = False
    template_def_pins = list(template_def_pins)
    for pin_name in template_def_pins:
