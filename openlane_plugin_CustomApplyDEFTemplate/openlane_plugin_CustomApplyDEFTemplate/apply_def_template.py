...
@click.option(
    "-t", "--template-pins", required=True, multiple=True, help="Template DEF"
)
@click_odb
def cli(reader, input_lefs, def_template, template_pins, permissive):
    defutil.relocate_pins(reader.db, input_lefs, def_template, template_pins)
